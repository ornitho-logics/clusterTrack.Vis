...
Once you have exported a bunch of interactive map HTML files with `map(ctdf) |> save_map(path = ...)`, you can call `site()` to create a simple browsable index for that folder.
