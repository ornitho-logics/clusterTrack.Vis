...
ctdf <- as_ctdf(ruff07b5, time = "timestamp") |>
  cluster_track()
#> Warning: Found 17 temporal gaps greater than 24 h (smallest: 25 h; largest:
#> 382.5 h). Split the file manually at these gaps before running the clustering.
